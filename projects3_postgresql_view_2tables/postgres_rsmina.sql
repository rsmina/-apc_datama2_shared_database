CREATE SCHEMA rsmina;


CREATE TABLE rsmina.presidents (
...
CREATE TABLE rsmina.companies (
    id serial CONSTRAINT companies_pk PRIMARY KEY,
    name varchar(100) NOT NULL,
    found_date date NOT NULL,
    president_id int NOT NULL,
    FOREIGN KEY (president_id) REFERENCES rsmina.presidents (id)
);

CREATE TABLE rsmina.employee_types (
    id serial CONSTRAINT employee_types_pk PRIMARY KEY,
    type varchar(20) NOT NULL,
    UNIQUE (type)
);

CREATE TABLE rsmina.employees (
    ...
    FOREIGN KEY (company_id) REFERENCES rsmina.companies (id),
    FOREIGN KEY (employee_type_id) REFERENCES rsmina.employee_types (id),
    UNIQUE (contact_number)
);

CREATE TABLE rsmina.florists (
    id serial CONSTRAINT florists_pk PRIMARY KEY,
    employee_id int NOT NULL,
    flower_variety_qty int NOT NULL,
    FOREIGN KEY (employee_id) REFERENCES rsmina.employees (id)
);

CREATE TABLE rsmina.drapers (
...
CREATE TYPE rsmina.license_types_enum
AS ENUM ('Non-Professional', 'Professional');

CREATE TABLE rsmina.license_types (
    id serial CONSTRAINT license_types_pk PRIMARY KEY,
    type rsmina.license_types_enum NOT NULL,
    UNIQUE (type)
);

CREATE TABLE rsmina.drivers (
    ...
    FOREIGN KEY (employee_id) REFERENCES rsmina.employees (id),
    FOREIGN KEY (license_type_id) REFERENCES rsmina.license_types (id),
    UNIQUE (license_num)
);

CREATE TABLE rsmina.resource_organizers (
...
CREATE TABLE rsmina.styling_assistants (
...
CREATE TABLE rsmina.event_types (
    id serial CONSTRAINT event_types_pk PRIMARY KEY,
    type varchar(50) NOT NULL,
    UNIQUE (type)
);

CREATE TABLE rsmina.events (
    ...
    FOREIGN KEY (company_id) REFERENCES rsmina.companies (id),
    FOREIGN KEY (event_type_id) REFERENCES rsmina.event_types (id),
    FOREIGN KEY (client_id) REFERENCES rsmina.clients (id)
);

CREATE TYPE rsmina.warehouse_types_enum
AS ENUM ('Public', 'Private', 'Rental');

CREATE TABLE rsmina.warehouse_types (
    id serial CONSTRAINT warehouse_types_pk PRIMARY KEY,
    type rsmina.warehouse_types_enum NOT NULL
);

CREATE TABLE rsmina.warehouses (
    id serial CONSTRAINT warehouses_pk PRIMARY KEY,
    company_id int NOT NULL,
    warehouse_type_id int NOT NULL,
    location varchar(255) NOT NULL,
    FOREIGN KEY (company_id) REFERENCES rsmina.companies (id),
    FOREIGN KEY (warehouse_type_id) REFERENCES rsmina.warehouse_types (id),
    UNIQUE (location)
);

INSERT INTO rsmina.presidents (fname, mname, lname, address, contact_number, email_address)
VALUES
...
INSERT INTO rsmina.clients (fname, mname, lname, contact_number, email_address)
VALUES
...
INSERT INTO rsmina.companies (name, found_date, president_id)
VALUES
...
INSERT INTO rsmina.employee_types (type)
VALUES
('drivers'),
('drapers'),
('florists'),
...
INSERT INTO rsmina.employees (fname, mname, lname, contact_number, address, company_id, employee_type_id)
VALUES
...
INSERT INTO rsmina.florists (employee_id, flower_variety_qty)
VALUES
(11, 30),
(12, 40),
(13, 45),
...
INSERT INTO rsmina.drapers (employee_id, certification_qty, years_experience, exhibit_qty)
VALUES
(6, 2, 5, 10),
(7, 4, 2, 7),
(8, 7, 3, 6),
...
INSERT INTO rsmina.license_types (type)
VALUES
('Non-Professional'),
('Professional');

INSERT INTO rsmina.drivers (employee_id, license_num, license_expiry, license_type_id)
VALUES
...
INSERT INTO rsmina.resource_organizers (employee_id, years_experience, description)
VALUES
(21, 5, 'Self-motivated'),
...
INSERT INTO rsmina.styling_assistants (employee_id, certification_qty, years_experience, specialization)
VALUES
...
INSERT INTO rsmina.event_types (type)
VALUES
('Wedding'),
('Birthday'),
('Christening'),
...
INSERT INTO rsmina.events (company_id, event_type_id, client_id, location, startdate, enddate)
VALUES
...
INSERT INTO rsmina.warehouse_types (type)
VALUES
('Public'),
('Private'),
('Rental');

INSERT INTO rsmina.warehouses (company_id, warehouse_type_id, location)
VALUES
